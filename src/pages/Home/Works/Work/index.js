 ...
 * @property {number} height - The height of the image (property matches database key).
 */
...
export default function Work({ data } = {}) {
  ...
  const bgImg = createElement({
    ...
    attributes: {
      ...
      height: data.images.backgroundImg.height,
    },
  });
  ...
  if (data?.featured) append(container, [FeaturedTag()]);
